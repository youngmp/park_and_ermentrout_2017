"""
generate movie of the effects of small perturbations on traveling bump solution. side-by-side with centroid and full bump solution in heatmap form
...
def main():
    ...
    zshift_angle=pi/6.;zshift_rad=.5
